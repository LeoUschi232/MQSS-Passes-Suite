...
class SSToZ : public BaseMQSSPass<SSToZ> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(SSToZ)

  llvm::StringRef getArgument() const override { return "SSToZ"; }

  llvm::StringRef getDescription() const override { return "Replace S S by Z"; }
